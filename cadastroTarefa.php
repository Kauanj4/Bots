<HTML>
   ...
   <BODY>
      ...
      <?php
         ...
         if(isset($_GET["opcaoPost"])){
            ...
            while($linha = $comando->fetch()){
               $descricaoBusca = $linha["descricao"];
               $setorBusca = $linha["setor"];
               $usuarioBusca = $linha["codigoUsuario"];
               $prioridadeBusca = $linha["prioridade"];
            }
         }else{
            $opcaoPost = "";
         }
      ...
      <TABLE CLASS="tabela">
         ...
         <TR><TD COLSPAN="4" CLASS="linhaCampo"><INPUT TYPE="text" NAME="descTarefa"  ID="descTarefa" VALUE="<?php print $descricaoBusca;?>"></TD></TR>
         <TR><TD COLSPAN="4" CLASS="linhaTexto">Setor:</TD></TR>
         <TR><TD COLSPAN="4" CLASS="linhaCampo"><INPUT TYPE="text" NAME="setortarefa" ID="setortarefa" VALUE="<?php print $setorBusca;?>"></TD></TR>
         ...
         <TR><TD COLSPAN="4" CLASS="linhaCampo">
            <SELECT ID="prioridadeTarefa" NAME="prioridadeTarefa">
               <OPTION VALUE="Baixa" <?php print ($prioridadeBusca=="Baixa"?"SELECTED":"") ?>>Baixa</OPTION>
               <OPTION VALUE="Media" <?php print ($prioridadeBusca=="Media"?"SELECTED":"") ?>>Média</OPTION>
               <OPTION VALUE="Alta"  <?php print ($prioridadeBusca=="Alta"?"SELECTED":"") ?>>Alta</OPTION>
            </SELECT>
         </TD></TR>
         <?php
            if(isset($_GET["opcaoPost"])){
